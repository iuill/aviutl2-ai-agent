...
[![Platform](https://img.shields.io/badge/platform-Windows%20x64-0078D4?logo=windows11)](https://github.com/iuill/aviutl2-ai-agent/blob/main/docs/compatibility.md)
...
1. 展開した`aviutl2-agent-plugin.aux2`をAviUtl2の`data\Plugin`へコピーします。
